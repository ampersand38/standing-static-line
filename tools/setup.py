...
def main():
    ...
    print("""
  ######################################
  # SSL Development Environment Setup #
  ######################################

  This script will create your SSL dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your SSL project folder:
    [Arma 3 installation directory]\\{} => SSL project folder
    P:\\{}                              => SSL project folder
