...
* Exsslle:
* [player, vehicle player, "proxy:\a3\data_f\proxies\passenger_low01\cargo.001"] call ssl_main_fnc_moveSeatLocal
* [player, cursorObject, ""] call ssl_main_fnc_moveSeatLocal
*/

params ["_unit", "_vehicle", "_proxy"];

if (ssl_main_isSeatTaken && {_vehicle == vehicle _unit}) exitWith {false};
